...
posicionInicial = vector(0.0, -0.25 ,0.0)
velocidadInicial = vector(0.25, -1.0, 0.25)
...
sistemaGenerado = generaColumnaCono(posicionInicial, 0.1, 8, 13, separacion, velocidadInicial, radio)
